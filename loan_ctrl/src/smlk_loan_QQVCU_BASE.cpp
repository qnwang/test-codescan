...
SMLK_BOOL SMLK_LOAN_QQVCU_BASE::Send0F3D(SMLK_BOOL need_handshake)
{
...
SMLK_BOOL SMLK_LOAN_QQVCU_BASE::DoLoanActive(IN LoanCmdMsg &queue, OUT SMLK_UINT8 &result, std::vector<SMLK_UINT8> &i_gpsid, std::vector<SMLK_UINT8> &i_key)
{
...
SMLK_BOOL SMLK_LOAN_QQVCU_BASE::CheckIgnonTime()
{
    return SMLK_TRUE;
}

SMLK_BOOL SMLK_LOAN_QQVCU_BASE::ResultEncode(IN LoanCtrlResult &result)
{
    SMLK_LOGD("enter in func(SMLK_LOAN_QQVCU_BASE::%s)\n", __func__);
...
void SMLK_LOAN_QQVCU_BASE::EncodeMcuReport(SMLK_UINT8 result)
{
    SMLK_LOGD("enter in func(SMLK_LOAN_QQVCU_BASE::%s)\n", __func__);
    std::vector<SMLK_UINT8> output_vec;
    Msg0f40Resp resp;
