...
*                               头文件引用                                   *
*****************************************************************************/
#ifndef _SMLK_LOAN_EMS_YUCHAI_H_
#define _SMLK_LOAN_EMS_YUCHAI_H_
...
class SMLK_LOAN_EMS_YUCHAI : public SmlkEmsLoanCtrl
{
public:
    SMLK_LOAN_EMS_YUCHAI()
    {
        m_isYuchai = true;
    };
    virtual ~SMLK_LOAN_EMS_YUCHAI(){};
protected:
...
#endif // _SMLK_LOAN_EMS_YUCHAI_H_
