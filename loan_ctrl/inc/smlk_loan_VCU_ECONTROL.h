...
*                               头文件引用                                   *
*****************************************************************************/
#ifndef _SMLK_LOAN_VCU_ECONTROL_H_
#define _SMLK_LOAN_VCU_ECONTROL_H_
...
namespace smartlink {
namespace LOAN {
class SMLK_LOAN_VCU_ECONTROL : public SmlkEmsLoanCtrl
{
public:
    SMLK_LOAN_VCU_ECONTROL()
    {
        m_read_svc_id  = 0x22;
        m_write_svc_id = 0x2F;
    ...
    virtual ~SMLK_LOAN_VCU_ECONTROL(){};
protected:
    SMLK_BOOL EncryptSeedKey(std::vector<SMLK_UINT8>& vec /*IN OUT*/);
};
}
}
#endif // _SMLK_LOAN_EMS_VCU_ECONTROL_H_
