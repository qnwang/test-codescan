...
*                               头文件引用                                   *
*****************************************************************************/
#ifndef _SMLK_LOAN_HCU_FAW_H_
#define _SMLK_LOAN_HCU_FAW_H_
...
namespace smartlink {
namespace LOAN {
class SMLK_LOAN_HCU_FAW : public SmlkEmsLoanCtrl
{
public:
    SMLK_LOAN_HCU_FAW()
    {
        ...
        m_ign_delay_time = 20;
        m_keylen       = 4;
        m_encrypt_lib_path     = "/oemapp/smartlink/lib/libHCU_Seedkey_Algorithm.so";
    ...
    virtual ~SMLK_LOAN_HCU_FAW(){};
public:
    // SMLK_BOOL DoLoanCmd(IN LoanCmdData& data);
};
}
}
#endif // _SMLK_LOAN_HCU_FAW_H_
